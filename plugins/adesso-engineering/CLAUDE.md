# adesso-engineering Plugin Development
...
├── review/        # Code review agents (code-simplicity, data-migration, deployment-verification, pattern-recognition)
...
## adesso-engineering Workflow (v1.0.0)
...
**Consolidated skills with Domain Expertise Pattern:**
...
### Agent Categories (38 total)

**Core Agents (6):** `frontend-engineer`, `librarian`, `document-writer`, `reviewer-selector`, `skill-invoker`, `gemini-frontend`

**Review Agents (4):** `code-simplicity-reviewer`, `data-migration-expert`, `deployment-verification-agent`, `pattern-recognition-specialist`
...
### After Implementation: code-simplicity-reviewer (MANDATORY)
