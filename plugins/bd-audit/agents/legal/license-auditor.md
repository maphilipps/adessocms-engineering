...
updateProgress({ agent: "license-auditor", status: "running", started_at: new Date().toISOString() })

// 2. Sofort Header schreiben
Write("legal/licenses.md", headerContent)

// 3. Inkrementell Ergebnisse anhängen
results.forEach(r => Append("legal/licenses.md", formatResult(r)))

// 4. Bei Ende: Progress melden
updateProgress({ agent: "license-auditor", status: "completed", summary: {...} })
```
