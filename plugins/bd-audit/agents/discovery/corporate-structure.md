...
updateProgress({ agent: "corporate-structure", status: "running", started_at: new Date().toISOString() })

// 2. Sofort Header schreiben
Write("discovery/corporate.md", headerContent)

// 3. Inkrementell Ergebnisse anhängen
results.forEach(r => Append("discovery/corporate.md", formatResult(r)))

// 4. Bei Ende: Progress melden
updateProgress({ agent: "corporate-structure", status: "completed", summary: {...} })
```
