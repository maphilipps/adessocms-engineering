...
updateProgress({ agent: "ux-auditor", status: "running", started_at: new Date().toISOString() })

// 2. Sofort Header schreiben
Write("ux/ux_overview.md", headerContent)

// 3. Inkrementell Ergebnisse anhängen
results.forEach(r => Append("ux/ux_overview.md", formatResult(r)))

// 4. Bei Ende: Progress melden
updateProgress({ agent: "ux-auditor", status: "completed", summary: {...} })
```
