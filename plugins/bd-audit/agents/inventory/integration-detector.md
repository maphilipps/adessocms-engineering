...
updateProgress({ agent: "integration-detector", status: "running", started_at: new Date().toISOString() })

// 2. Sofort Header schreiben
Write("inventory/integrations.md", headerContent)

// 3. Inkrementell Ergebnisse anhängen
results.forEach(r => Append("inventory/integrations.md", formatResult(r)))

// 4. Bei Ende: Progress melden
updateProgress({ agent: "integration-detector", status: "completed", summary: {...} })
```
