...
updateProgress({ agent: "page-type-analyzer", status: "running", started_at: new Date().toISOString() })

// 2. Sofort Header schreiben
Write("inventory/page_types.md", headerContent)

// 3. Inkrementell Ergebnisse anhängen
results.forEach(r => Append("inventory/page_types.md", formatResult(r)))

// 4. Bei Ende: Progress melden
updateProgress({ agent: "page-type-analyzer", status: "completed", summary: {...} })
```
