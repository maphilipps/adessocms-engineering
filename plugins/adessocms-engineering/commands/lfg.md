...
**Step 1:** Use the Skill tool to invoke `ralph-wiggum:ralph-loop` with args: `"finish all slash commands" --completion-promise "DONE"`
...
Start with Step 1 now - invoke the Skill tool with skill="ralph-wiggum:ralph-loop".
